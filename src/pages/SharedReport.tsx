  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 print:p-0">
        ...
        <footer className="mt-8 pt-4 border-t border-border text-center text-[10px] text-muted-foreground font-mono">
          Generated by Car Insights AI · Read-only diagnostic report
        </footer>
      </div>
